...
router.get("/office/diary", async (req, res): Promise<void> => {
  try {
    ...
    res.json(rows.map((r: any) => ({ ...r.d, authorName: r.authorName, createdAt: safeIso(r.d.createdAt) })));
  } catch (err: any) {
    console.error("[GET /office/diary ERROR]", err);
    res.json([]);
  }
});
...
router.post("/office/diary", async (req, res): Promise<void> => {
  try {
    ...
    console.error("[POST /office/diary ERROR]", err);
...
router.put("/office/diary/:id", async (req, res): Promise<void> => {
  try {
    ...
    console.error("[PUT /office/diary/:id ERROR]", err);
...
router.delete("/office/diary/:id", async (req, res): Promise<void> => {
  try {
    ...
    console.error("[DELETE /office/diary/:id ERROR]", err);
...
router.get("/office/tasks", async (req, res): Promise<void> => {
  try {
    ...
    res.json(rows.map((r: any) => ({ ...r.t, assignedName: r.assignedName, createdAt: safeIso(r.t.createdAt) })));
  } catch (err: any) {
    console.error("[GET /office/tasks ERROR]", err);
    res.json([]);
  }
});
...
router.post("/office/tasks", async (req, res): Promise<void> => {
  try {
    ...
    console.error("[POST /office/tasks ERROR]", err);
...
router.patch("/office/tasks/:id", async (req, res): Promise<void> => {
  try {
    ...
    console.error("[PATCH /office/tasks/:id ERROR]", err);
...
router.delete("/office/tasks/:id", async (req, res): Promise<void> => {
  try {
    ...
    console.error("[DELETE /office/tasks/:id ERROR]", err);
...
router.get("/office/complaints", async (req, res): Promise<void> => {
  try {
    ...
    res.json(rows.map((r: any) => ({ ...r.c, customerName: r.customerName, createdAt: safeIso(r.c.createdAt) })));
  } catch (err: any) {
    console.error("[GET /office/complaints ERROR]", err);
    res.json([]);
  }
});
...
router.post("/office/complaints", async (req, res): Promise<void> => {
  try {
    ...
    console.error("[POST /office/complaints ERROR]", err);
...
router.patch("/office/complaints/:id", async (req, res): Promise<void> => {
  try {
    ...
    console.error("[PATCH /office/complaints/:id ERROR]", err);
...
router.get("/office/donations", async (req, res): Promise<void> => {
  try {
    ...
    res.json(rows.map((r: any) => ({ ...r.d, customerName: r.customerName, createdAt: safeIso(r.d.createdAt) })));
  } catch (err: any) {
    console.error("[GET /office/donations ERROR]", err);
    res.json([]);
  }
});
...
router.post("/office/donations", async (req, res): Promise<void> => {
  try {
    ...
    console.error("[POST /office/donations ERROR]", err);
...
router.get("/office/summary", async (_req, res): Promise<void> => {
  try {
    ...
    console.error("[GET /office/summary ERROR]", err);
    res.json({ openComplaints: 0, pendingTasks: 0, inProgressTasks: 0, todayDiaryEntries: 0 });
  }
});
...
router.get("/office/expenses", async (req, res): Promise<void> => {
  try {
    ...
    res.json(rows.map((r: any) => ({ ...r, createdAt: safeIso(r.createdAt) })));
  } catch (err: any) {
    console.error("[GET /office/expenses ERROR]", err);
    res.json([]);
  }
});
...
router.post("/office/expenses", async (req, res): Promise<void> => {
  try {
    ...
    console.error("[POST /office/expenses ERROR]", err);
...
router.delete("/office/expenses/:id", async (req, res): Promise<void> => {
  try {
    ...
    console.error("[DELETE /office/expenses/:id ERROR]", err);
